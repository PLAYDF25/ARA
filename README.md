...
function AIMMENU()
AIMM = gg.multiChoice({"[1] Micro AimBot","[2] Medium AimBot","[3] Ultra AimBot","[BACK]"}, nil, 'AimBot Menu USE IN LOBBY')
if AIMM == nil then
...
function MBMM()
MB = gg.multiChoice({"[1] Magic Bullet v4","[2] Magic Bullet v5","[BACK]"}, nil, 'Magic Bullet Menu USE IN GAME')
if MB == nil then
...
function WHMM()
WHH = gg.multiChoice({"[1] Player WallHack v1","[2] Player WallHack v2","[3] Player WallHack v3","[4] Item WallHack","[BACK]"}, nil, 'WallHack Menu USE IN GAME')
if WHH == nil then
...
function AIMMENUR()
AIMM = gg.multiChoice({"[1] Слабая Автоматическая Наводка","[2] Средняя Автоматическая Наводка","[3] Максимальная Автоматическая Наводка","[НАЗАД]"}, nil, 'Меню Автоматической Наводки ИСПОЛЬЗОВАТЬ В ЛОББИ')
if AIMM == nil then
...
function MBMMR()
MB = gg.multiChoice({"[1] Магическая Пуля v4","[2] Магическая Пуля v5","[НАЗАД]"}, nil, 'Меню Магической Пули ИСПОЛЬЗОВАТЬ В ИГРЕ')
if MB == nil then
...
function WHMMR()
WHH = gg.multiChoice({"[1] Видеть Противника Сквозь Стены v1","[2] Видеть Противника Сквозь Стены v2","[3] Видеть Противника Сквозь Стены v3","[4] Видеть Предметы Сквозь Стены","[НАЗАД]"}, nil, 'Меню Вида Сквозь Стены ИСПОЛЬЗОВАТЬ В ИГРЕ')
if WHH == nil then
